 ...
 *
 */
public final class NaturalNumberRoot3 {

    /**
     * Private constructor so this utility class cannot be instantiated.
     */
    private NaturalNumberRoot3() {
    }
    ...
    public static void root(NaturalNumber n, int r) {
        ...
        //While loop to go through and figure out root
        while (result.compareTo(one) == 1) {
            ...
            //Get the power for n to compare to
            temp.copyFrom(guess);
            temp.power(r);
